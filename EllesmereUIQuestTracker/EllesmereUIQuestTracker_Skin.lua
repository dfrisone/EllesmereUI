...
-------------------------------------------------------------------------------
-- Hidden-tracker mouse suppression. Every alpha-0 state (the combat -- eui-style: allow comment-budget (input-state reference)
...
-- Tracker-wide mouse switch, driven by the Visibility file on every alpha -- eui-style: allow comment-budget (state restoration reference)
