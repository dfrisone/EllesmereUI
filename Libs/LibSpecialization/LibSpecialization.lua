...
local LS, oldminor = LibStub:NewLibrary("LibSpecialization", 27.4) -- Local Forever specialization compatibility
...
local positionTable = wowID == cataWowID and {
	...
	[1484] = "RANGED", -- Forever Druid classification
	-- Evoker
	...
	[1485] = "RANGED", -- Forever Hunter classification
	-- Mage
	[62] = "RANGED", -- Arcane
	[63] = "RANGED", -- Fire
	[64] = "RANGED", -- Frost
	[1482] = "RANGED", -- Forever Mage classification
	-- Monk
...
local roleTable = wowID == cataWowID and {
	...
	[1484] = "DAMAGER", -- Forever Druid classification
	-- Evoker
	...
	[1485] = "DAMAGER", -- Forever Hunter classification
	-- Mage
	[62] = "DAMAGER", -- Arcane
	[63] = "DAMAGER", -- Fire
	[64] = "DAMAGER", -- Frost
	[1482] = "DAMAGER", -- Forever Mage classification
	-- Monk
		...
		if specIndex then
			...
			if type(specId) == "number" and specId > 0 then
				...
				if position and role then
					...
					-- A client can introduce a specialization before this fixed
					-- role/position table knows it. Callers treat nil as unavailable.
				end
			end
		end
	end
